...
// $response = $telegramBotClient->sendDocument('1123756923', 'C:\Users\user\Desktop\Новаяпапка\1.xlsx'); // отправка сообщения
// print_r($response);

phpinfo();

// $arr = $telegramBotClient->getUpdates(); // запись в БД данных из входящих сообщений
